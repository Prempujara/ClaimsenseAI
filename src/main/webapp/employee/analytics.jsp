...
<head>
    ...
    <title>Personal Spending Analytics - ClaimSense AI</title>
    ...
    <main class="main">
        ...
        <div class="content">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px; flex-wrap: wrap; gap: 16px;">
                <div>
                    <h2 style="font-size: 22px; font-weight: 800; margin: 0 0 2px; letter-spacing: -0.4px;">Personal Spending Analytics</h2>
                    <p style="color: var(--text-muted); font-size: 13px; margin: 0;">
                        Analyze your expense breakdown, status ratios, and category metrics.
                    </p>
                </div>
            </div>
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <div style="text-align: center; color: var(--text-muted); padding: 36px;">
                                    ...
                                    <span style="font-size: 11px; color: var(--text-muted);">Category totals will visualize as you submit expenses.</span>
                                </div>
                            </c:otherwise>
                        </c:choose>
                    </div>
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <div style="text-align: center; color: var(--text-muted); padding: 36px;">
                                    ...
                                    <span style="font-size: 13px; font-weight: 600; color: var(--text-main); display: block;">No Submissions Recorded</span>
                                    <span style="font-size: 11px; color: var(--text-muted);">Status distribution chart will appear here.</span>
                                </div>
                            </c:otherwise>
                        </c:choose>
                    </div>
            ...
            <div class="table-box" style="margin-bottom: 32px;">
                <div class="box-header" style="margin-bottom: 16px;">
                    <h4 style="font-size: 15px; font-weight: 800;">Category Expense Breakdown</h4>
                </div>
                    ...
                    <table class="custom-table">
                        ...
                        <tbody>
                            ...
                            <c:if test="${empty categoryTotals}">
                                <tr>
                                    <td colspan="2" style="text-align: center; color: var(--text-muted); padding: 24px;">No expense categories recorded yet.</td>
                                </tr>
                            </c:if>
                        </tbody>
                    </table>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        <c:if test="${chartHasData}">
            const catCanvas = document.getElementById("employeeCategoryChart");
            if (catCanvas) {
                new Chart(catCanvas, {
                    type: 'bar',
                    data: {
