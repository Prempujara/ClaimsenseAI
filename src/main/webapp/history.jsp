...
<head>
    ...
    <title>Approval History - ClaimSense AI</title>
    ...
    <main class="main">
        ...
        <div class="content">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px; flex-wrap: wrap; gap: 16px;">
                <div>
                    <h2 style="font-size: 22px; font-weight: 800; margin: 0 0 2px; letter-spacing: -0.4px;">Approval & Decision History</h2>
                    <p style="color: var(--text-muted); font-size: 13px; margin: 0;">
                        ${user.manager ? 'Complete audit trail of all organizational expense claim decisions.' : 'Audit history of your submitted claim statuses and manager decisions.'}
                    </p>
                </div>
            </div>
            ...
            <div class="table-box" style="margin-bottom: 32px;">
                <div class="box-header" style="margin-bottom: 16px;">
                    <h4 style="font-size: 15px; font-weight: 800;">Claim Activity Audit Log</h4>
                </div>
                        ...
                        <tbody>
                            <c:forEach var="e" items="${expenses}">
                                <tr>
                                    ...
                                    <td><span style="font-weight: 600; color: var(--text-main);">${fn:escapeXml(e.employeeName)}</span></td>
                                    <td><span style="font-weight: 600; color: var(--text-main);">${fn:escapeXml(e.title)}</span></td>
                            ...
                            <c:if test="${empty expenses}">
                                <tr>
                                    <td colspan="8" style="text-align: center; color: var(--text-muted); padding: 40px 16px;">
                                        ...
                                        <span style="font-size: 14px; font-weight: 700; color: var(--text-main); display: block; margin-bottom: 2px;">No approval history recorded yet</span>
                                        <span style="font-size: 12px; color: var(--text-muted);">As claims are submitted and reviewed, history records will list here.</span>
                                    </td>
                                </tr>
                            </c:if>
                        </tbody>
